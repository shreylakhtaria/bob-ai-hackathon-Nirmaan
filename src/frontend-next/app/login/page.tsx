            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="flex h-12 w-full rounded-full border border-border/60 bg-background px-4 py-2 text-base ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 md:text-sm"
                />
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="flex h-12 w-full rounded-full border border-border/60 bg-background px-4 py-2 pr-10 text-base ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 md:text-sm"
                  />
                  <button
                    type="button"
