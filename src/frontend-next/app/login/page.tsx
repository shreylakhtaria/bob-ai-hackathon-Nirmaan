...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      err(e.message || "Invalid email or password");
    } finally {
      setIsLoading(false);
    }
  }
  ...
  return (
    <>
      ...
      <div className="wk-login min-h-screen max-h-screen overflow-hidden grid lg:grid-cols-2 w-full absolute inset-0">
        ...
        <div className="flex items-center justify-center p-8 bg-background relative z-10 w-full h-full">
          <div className="w-full max-w-[420px]">
            <div className="lg:hidden flex items-center justify-center gap-2 text-lg font-semibold mb-12">
              <Image src="/favicon.png" alt="Grid Risk Advisor" width={32} height={32} />
              <span className="font-mono text-sm tracking-wider uppercase text-[#0b1c30]">Grid Risk Advisor</span>
            </div>
            ...
            <div className="mb-10">
              ...
              <h1 className="text-3xl font-bold tracking-tight mb-2 text-[#0b1c30]">Welcome back!</h1>
              <p className="text-muted-foreground text-sm">Please enter your operator login details</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="flex h-12 w-full rounded-full border border-border/60 bg-background px-4 py-2 text-base ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 md:text-sm text-[#0b1c30]"
                />
                {emailError && <p className="text-xs text-[#ba1a1a] font-mono">{emailError}</p>}
              </div>

              <div className="space-y-2">
                <label htmlFor="password" className="text-xs font-mono font-bold uppercase text-[#404942]">Password</label>
                <div className="relative">
                  <input
                    ...
                    className="flex h-12 w-full rounded-full border border-border/60 bg-background px-4 py-2 pr-10 text-base ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 md:text-sm text-[#0b1c30]"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    ...
                    className="h-4 w-4 rounded-sm border border-[#0f5132] accent-[#0f5132]"
                  />
                  <span className="text-xs font-mono text-[#55554f]">Keep me signed in</span>
                </label>
                <button
                  type="button"
                  onClick={() => err("Contact system administrator to reset credentials.")}
                  className="text-xs font-mono text-[#0f5132] hover:underline font-semibold"
                >
                  Reset credentials
                </button>
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="group relative w-full h-12 cursor-pointer overflow-hidden rounded-full border border-[#003820] bg-[#0f5132] text-white px-6 py-2 text-center font-semibold disabled:opacity-50"
              >
            ...
            <div className="text-center text-sm text-muted-foreground mt-8">
              ...
              <Link href="/signup" className="text-[#0f5132] hover:underline font-semibold">
